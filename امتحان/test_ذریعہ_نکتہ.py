...
class امتحان_ذریعہ_نکتہ(unittest.TestCase):
    ...
    def setUpClass(قسم):
        ...
        قسم.ذرائع = {
            'جسان': جےسن(مسل_جسان, *قسم.جگہ, تبديل_عمودی_ستون=تبدل),
            'پای_جسان': جےسن(پای_جسان, *قسم.جگہ),
        ...
        قسم.خاکے = '۲۔۶'
        قسم.ذرائع_خاکے = {
            'جسان': جےسن(مسل_جسان, *قسم.جگہ, خاکے=قسم.خاکے, تبديل_عمودی_ستون=تبدل),
            'پای_جسان': جےسن(پای_جسان, *قسم.جگہ, خاکے=قسم.خاکے),
